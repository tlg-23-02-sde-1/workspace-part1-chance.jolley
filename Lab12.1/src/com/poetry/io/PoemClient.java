...
public class PoemClient {
    ...
    private static void writePoem() {
          String haiku = "Big white mug in hand...\n" +
                         "Aroma fills the sleepy air\n" +
...
//            out.println("Big white mug in hand");
//            out.println("Aroma fills the sleepy air");
//            out.println("Coffee starts my day");
//        }
//        catch (IOException e) {
//            e.printStackTrace();
//        }
